...
def format_dolly(sample):
    ...
    # Filtering out the samples with empty responses
...
train_dataset = train_val["train"].train_test_split(test_size=0.125, seed=42)
final_dataset = {
...
# Preparing Model for k-bit Training BEFORE applying PEFT
...
# Apply PEFT AFTER preparing for k-bit training
